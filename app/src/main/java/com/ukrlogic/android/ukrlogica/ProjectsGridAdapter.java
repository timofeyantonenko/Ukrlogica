 ...
 */
public class ProjectsGridAdapter  extends RecyclerView.Adapter<ProjectsGridAdapter.ViewHolder> {

    List<EndangeredItem> mItems;

    public ProjectsGridAdapter() {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.projects_grid_item, viewGroup, false);
